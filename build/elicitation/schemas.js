...
exports.ElicitationSchemas = void 0;
exports.createElicitationRequest = createElicitationRequest;
/**
 ...
 * ```
 */
function createElicitationRequest(message, schema) {
    return {
