...
exports.promptApiMapping = exports.ciscoPrompts = void 0;
exports.getFilteredPrompts = getFilteredPrompts;
/**
 * Cisco Support MCP Prompts
 * These prompts provide guided workflows for common Cisco support scenarios
 */
exports.ciscoPrompts = [
    {
 ...
 */
function getFilteredPrompts(enabledApis) {
    return exports.ciscoPrompts.filter(prompt => {
        const requiredApis = exports.promptApiMapping[prompt.name];
        if (!requiredApis) {
...
//# sourceMappingURL=cisco-prompts.js.map