...
class CaseApi extends base_api_js_1.BaseApi {
    baseUrl = 'https://apix.cisco.com/case/v3';
    apiName = 'Case';
    getTools() {
        return [
            {
    ...
    async executeTool(name, args, meta) {
        ...
        switch (name) {
            ...
            case 'search_cases_by_contract':
                ...
                if (processedArgs.status_flag)
                    apiParams.status_flag = processedArgs.status_flag;
                if (processedArgs.date_created_from)
                    apiParams.date_created_from = processedArgs.date_created_from;
                if (processedArgs.date_created_to)
                    apiParams.date_created_to = processedArgs.date_created_to;
                apiParams.sort_by = processedArgs.sort_by || 'UPDATED_DATE';
