...
exports.SmartBondingApi = void 0;
const smart_bonding_base_api_js_1 = require("./smart-bonding-base-api.js");
/**
 ...
 */
class SmartBondingApi extends smart_bonding_base_api_js_1.SmartBondingBaseApi {
    getTools() {
        return [
            {
    ...
    async getTspCodes(args) {
        ...
        const result = await this.makeApiCall('/tspcodes', 'GET', undefined, params);
     ...
     * GET /pull/call
     */
    async pullTickets(args) {
        const correlationId = args.correlation_id;
        const result = await this.makeApiCall('/pull/call', 'GET', undefined, {}, correlationId);
        // Add experimental warning to response
        return {
            ...result,
            _experimental_warning: '⚠️ This is an EXPERIMENTAL/UNTESTED feature. Smart Bonding API requires credentials from Cisco Account Manager.',
    ...
    async createTicket(args) {
        ...
        const result = await this.makeApiCall('/push/call', 'POST', ticketData, {}, correlationId);
        return {
            ...result,
            _experimental_warning: '⚠️ This is an EXPERIMENTAL/UNTESTED feature. Smart Bonding API requires credentials from Cisco Account Manager.',
            _environment: process.env.SMART_BONDING_ENV || 'production',
    ...
    async uploadFile(args) {
        const ticketNumber = args.ticket_number;
        const uploadToken = args.upload_token;
        const uploadDomain = args.upload_domain || 'cxd.cisco.com';
...
exports.SmartBondingApi = SmartBondingApi;
//# sourceMappingURL=smart-bonding-api.js.map