...
exports.PsirtApi = void 0;
const base_api_js_1 = require("./base-api.js");
class PsirtApi extends base_api_js_1.BaseApi {
    ...
    async getAllSecurityAdvisories(args) {
        const params = {};
        ...
        if (args.summary_details)
            params.summaryDetails = args.summary_details;
        if (args.product_names)
            params.productNames = args.product_names;
    ...
    async getSecurityAdvisoryByCve(args) {
        const params = {};
        if (args.summary_details)
            params.summaryDetails = args.summary_details;
        if (args.product_names)
    ...
    async getSecurityAdvisoriesBySeverity(args) {
        const params = {};
        if (args.page_index !== undefined)
            params.pageIndex = args.page_index;
        if (args.page_size !== undefined)
    ...
    async getSecurityAdvisoryByBugId(args) {
        const params = {};
        if (args.summary_details)
            params.summaryDetails = args.summary_details;
        if (args.product_names)
    ...
    async getLatestSecurityAdvisories(args) {
        const params = {};
        if (args.summary_details)
            params.summaryDetails = args.summary_details;
        if (args.product_names)
    ...
    async getSecurityAdvisoriesByYear(args) {
        const params = {};
        if (args.page_index !== undefined)
            params.pageIndex = args.page_index;
        if (args.page_size !== undefined)
    ...
    async getSecurityAdvisoriesByFirstPublished(args) {
        const params = {
    ...
    formatSecurityAdvisoryResponse(data, title) {
        ...
        const formattedAdvisories = advisories.map((advisory) => this.formatAdvisory(advisory));
        return {
            data: {
                title,
...
exports.PsirtApi = PsirtApi;
//# sourceMappingURL=psirt-api.js.map